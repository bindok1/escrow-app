...
import ProductCarousel from '@/app/components/ecommerce/productDetail/ProductCarousel';
import Breadcrumb from '@/app/(DashboardLayout)/layout/shared/breadcrumb/Breadcrumb';
import PageContainer from '@/app/components/container/PageContainer';
import ProductDetail from '@/app/components/ecommerce/productDetail';
import ProductDesc from '@/app/components/ecommerce/productDetail/ProductDesc';
import ProductRelated from '@/app/components/ecommerce/productDetail/ProductRelated';
